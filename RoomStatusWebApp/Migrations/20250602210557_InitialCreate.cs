    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Capacity", "Email", "Location", "Name" },
                values: new object[,]
                {
                    { 1, 10, "toplanti1@company.com", "1. Kat", "Toplantı Odası 1" },
                    { 2, 8, "toplanti2@company.com", "2. Kat", "Toplantı Odası 2" },
                    { 3, 15, "toplanti3@company.com", "3. Kat", "Toplantı Odası 3" }
                });
